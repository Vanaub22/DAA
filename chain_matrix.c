//to determine the most efficient way to multiply matrices to minimize operations
#include<stdio.h>
#include<stdlib.h>
#include<limits.h>
...
void main(){
    ...
    printf("\nEnter the number of matrices that to be multiplied: ");
    scanf("%d",&n);
    ...
    printf("\nThe generated array is as follows: ");
    for(i=0;i<n;i++)
    printf("%d ",orders[i]);
    printf("\n");
    for(i=0;i<=n;i++){
